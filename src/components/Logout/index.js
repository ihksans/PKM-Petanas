...
class Logout extends Component {
  ...
  removeToken() {
    ...
    this.props.unsetLog()
    this.props.unsetAllPemohon()
    this.props.unsetAllKodeHal()
    this.props.unsetAllSuratKeluar()
    this.props.unsetAllPencatatan()
    this.props.unsetAllDisposisi()
    this.props.unsetAllPengingat()
    this.props.unsetSifatSurat()
    this.props.unsetDerajatSurat()
    this.handleLoading()
    logoutAuth()
  }
  unsetCurrentUser() {
