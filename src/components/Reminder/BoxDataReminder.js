  ...
  return (
    <>
      <div className="grid grid-cols-3 gap-0 w-96 p-2 bg-white text-sm">
        <div className="flex items-start ml-1 font-semibold">Batas Waktu</div>
        <div className="col-span-2">: {WaktuPengingat}</div>
        <div className="flex items-start ml-1 font-semibold">Nomor Surat</div>
        <div className="col-span-2">: {NomorSurat}</div>
