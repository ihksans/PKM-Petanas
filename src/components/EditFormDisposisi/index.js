                        ...
                        >
                          ...
                          <div className="flex flex-row grid grid-cols-2">
                            ...
                            >
                              ...
                              <div className="text-danger ml-1 mt-2"> *</div>
                            </div>
                            <div className="justify-end ">
                              <div
                                type="text"
                                    ...
                                    <div key={i}>
                                      ...
                                      x.idUnit != undefined ? (
                                        ...
                                        <>
                                          ...
                                          {x.err == true ? (
                                            <div className="text-danger text-xs mb-3">
                                              Kode unit, Nama unit harus diisi
                                              dan hanya huruf angka
                                            </div>
                                          ) : null}
                                        </>
                                      )}
                                      <div className="btn-box">
                                        {this.state.inputListSelect.length !==
                                          1 && (
                                          <button
                                            ...
                                            onClick={() =>
                                              this.handleRemoveClickSelect(i)
                                            }
                                          >
                                            <p
                                              className={
                                        ...
                                        {this.state.inputListSelect.length -
                                          ...
                                          i && (
                                          <button
                                            onClick={this.handleAddClickSelect}
                          ...
                          <div className="flex flex-row grid grid-cols-2">
                            ...
                            >
                              ...
                              <div className="text-danger mt-1 mr-2"> *</div>
                            </div>
                            <div className="justify-end ">
                              <textarea
                                type="text"
                          ...
                          <div className="flex flex-row grid grid-cols-2">
                            ...
                            >
                              ...
                              <div className="text-danger mt-2 mr-2"> *</div>
                            </div>
                            <div className="justify-end ">
                              <textarea
                                type="text"
...
export default connect(mapStateProps, { setAllDisposisi })(EditFormDisposisi)
