...
class EditFormSurat extends Component {
  ...
  handleModal() {
    this.setState({
      ...
      derajatSurat: this.props.SuratDetail.ID_DERAJAT_SURAT,
      nomorSurat: this.props.SuratDetail.NOMOR_SURAT,
      unitPemohon: this.props.SuratDetail.ID_PEMOHON,
      penandatangan: this.props.SuratDetail.PENANDATANGAN,
      // namaPemohon: this.props.SuratDetail.ID_PEMOHON,
      tujuanSurat: this.props.SuratDetail.TUJUAN_SURAT,
      perihal: this.props.SuratDetail.PERIHAL,
  ...
  async onSubmit(e) {
    ...
    if (
      ...
      // await this.validateNamaPemohon(this.state.namaPemohon)
      ...
      if (
        ...
        // this.state.errNamaPemohon == false &&
        ...
        // this.state.errCustomPemohonKodeUnit == false &&
        ...
        //   this.state.customKodePemohon != null
        // ) {
        ...
        // if (
        //   // this.state.customKodePemohon != null &&
        //   this.state.customNamaPemohon != null
        // ) {
        if (this.state.customInputPemohon == true) {
          ...
          await api()
            ...
            .then((response) => {
              ...
              console.log('id_pemohon 1:' + response.data.content.id)
            })
        } else {
          fd.append('id_pemohon', this.state.unitPemohon)
          console.log('id_pemohon 2:' + this.state.unitPemohon)
        }
        let formData = new FormData()
        formData.append('id', this.state.idPencatatan)
        formData.append('id_pengguna', this.props.User.currentUser.ID_PENGGUNA)
        formData.append('id_jenis_surat', this.props.SuratDetail.ID_JENIS_SURAT)
        ...
        fd.append('id_no_surat', this.props.SuratDetail.ID_NOMOR_SURAT)
                                  ...
                                  <div className="justify-end ">
                                    <div className="flex flex-row">
                                      {this.state.customInputPemohon ? (
                                        <input
                                          type="text"
                                          name="namaPemohon"
                                          placeholder="Silahkan isi nama pemohon"
                                          required
                                          id="namaPemohon"
                                          className={
                                            'focus:form-control   focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 focus:outline-none  w-56 text-sm text-black placeholder-gray-500 border border-gray-200 rounded-md py-2 pl-2 mb-3'
                                    ...
                                    {/* {this.state.customInputPemohon ? (
                                      <input
                                        ...
                                        onChange={this.handleCustomKodePemohon}
                                      />
                                    ) : null} */}
                                    {/* {this.state.errCustomPemohonKodeUnit &&
                                    this.state.customInputPemohon ? (
                                      <div className="text-danger text-xs mb-3">
                                ...
                                {/* <div className="flex flex-row grid grid-cols-2">
                                  ...
                                  <div className="justify-end ">
                                    <input
                                      type="text"
                                      name="namaPemohon"
                                      value={this.state.namaPemohon}
                                      required
                                      id="namaPemohon"
                                      className={
                                        'focus:form-control   focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 focus:outline-none w-56  text-sm text-black placeholder-gray-500 border border-gray-200 rounded-md py-2 pl-2 mb-3'
                                      }
                                      onChange={this.handleNamaPemohon}
                                    />
                                    {this.state.errNamaPemohon ? (
                                      <div className="text-danger text-xs mb-3">
                                        Nama Pemohon harus diisi
                                      </div>
                                    ) : (
...
export default connect(mapStateToProps, { setAllSuratKeluar })(EditFormSurat)
